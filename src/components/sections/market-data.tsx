...
export default function MarketDataSection() {
  ...
  const trends = [
    ...
    { period: 'Last 90 Days', price: '+4.3%', sales: '+22%', inventory: '+12%' },
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <Tabs defaultValue="current" className="w-full">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-12 bg-white/10 backdrop-blur-sm">
            <TabsTrigger value="current" className="data-[state=active]:bg-white/20 data-[state=active]:text-white text-gray-200">
              Current Stats
            </TabsTrigger>
            <TabsTrigger value="trends" className="data-[state=active]:bg-white/20 data-[state=active]:text-white text-gray-200">
              Market Trends
            </TabsTrigger>
          </TabsList>
                ...
                >
                  ...
                  <CardContent>
                    ...
                    <Badge 
                      variant="secondary"
                      className={`${
                        stat.changeType === 'positive' ? 'bg-[#16B286]/20 text-[#16B286] border-[#16B286]/30' : 
                        stat.changeType === 'negative' ? 'bg-red-400/20 text-red-300 border-red-400/30' : 
                ...
                >
                  ...
                  <CardContent className='space-y-3'>
                    <div className='flex justify-between items-center'>
                      ...
                      <Badge variant="secondary" className='bg-[#16B286]/20 text-[#16B286] border-[#16B286]/30'>
                        {trend.price}
                      </Badge>
                    </div>
                    <div className='flex justify-between items-center'>
