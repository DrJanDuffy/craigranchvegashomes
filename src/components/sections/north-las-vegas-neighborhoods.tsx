...
const neighborhoods: Neighborhood[] = [
  ...
  {
    name: 'Craig Ranch',
    description: 'Prestigious community with luxury homes and premium amenities',
    avgPrice: '$875K',
    homesAvailable: 25,
  ...
  },
  {
    ...
    avgPrice: '$550K',
    homesAvailable: 15,
    amenities: ['55+ Community', 'Resort Pool', 'Fitness Center', 'Social Activities'],
  ...
  },
  {
    ...
    avgPrice: '$380K',
    homesAvailable: 22,
    amenities: ['Mature Trees', 'Established Community', 'Convenient Location', 'Parks'],
  ...
  },
  {
    ...
    avgPrice: '$520K',
    homesAvailable: 30,
    amenities: ['New Construction', 'Modern Amenities', 'Community Pool', 'Playground'],
    image: '/images/heartland.jpg'
  },
  {
    name: 'Sun City Aliante',
    description: 'Active adult community with extensive amenities and activities',
    avgPrice: '$480K',
    homesAvailable: 20,
    amenities: ['55+ Community', 'Extensive Amenities', 'Social Activities', 'Golf'],
  ...
  },
  {
    ...
    avgPrice: '$680K',
    homesAvailable: 16,
    amenities: ['Master Planned', 'Luxury Homes', 'Resort Amenities', 'Nature Trails'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover the diverse communities of North Las Vegas, each offering unique amenities and lifestyle options
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-xl p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Whether you're looking for a family-friendly community, luxury living, or an active adult lifestyle, 
              North Las Vegas has the perfect neighborhood for you. Let us help you find your dream home.
            </p>
            <Link
              href="http://drjanduffy.realscout.com/onboarding"
