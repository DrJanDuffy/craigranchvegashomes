...
export const metadata = {
  ...
  description: 'Browse luxury homes for sale in Craig Ranch, Las Vegas. Find your dream home in one of Las Vegas\' most prestigious communities.',
};
      ...
      <div className="bg-gradient-to-r from-[#0A2540] to-[#3A8DDE] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-200 max-w-3xl">
            Discover luxury homes in one of Las Vegas&apos; most prestigious communities. 
            From single-family homes to luxury estates, find your perfect property in Craig Ranch.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <CardDescription>
                  Luxury homes with modern amenities, high-end finishes, and exceptional craftsmanship
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <CardDescription>
                  Convenient access to shopping, dining, entertainment, and excellent schools
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <CardDescription>
                  Properties sell quickly with strong appreciation and growing demand
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <CardDescription>
                  Competitive pricing with excellent value for luxury living in Las Vegas
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-[#F7F9FC]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Our expert team is here to help you find the perfect property in Craig Ranch. 
            Schedule a consultation or browse our current listings.
          </p>
