...
export const metadata = {
  ...
  description: 'Get in touch with Craig Ranch Vegas Homes. Contact our expert real estate team for buying, selling, or investing in Craig Ranch, Las Vegas.',
};
      ...
      <div className="bg-gradient-to-r from-[#0A2540] to-[#3A8DDE] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-200 max-w-3xl">
            Ready to find your dream home in Craig Ranch? Get in touch with our expert 
      ...
      <section className="py-16 bg-[#F7F9FC]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Browse our available properties or schedule a consultation to discuss 
            your real estate needs in Craig Ranch.
          </p>
