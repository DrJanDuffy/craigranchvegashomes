...
export const metadata = {
  ...
  description:
    "Learn about Craig Ranch, one of Las Vegas' most prestigious communities. Discover schools, amenities, location, and what makes this neighborhood special.",
};
...
export default function NeighborhoodPage() {
  const highlights = [
    ...
    },
    {
      ...
      description:
        'Beautiful parks, walking trails, and recreational facilities throughout the area',
      color: 'text-[#0A2540]',
    ...
    },
    {
      ...
      title: 'Easy Access',
      description:
        'Close to major highways with easy access to downtown Las Vegas and the Strip',
      color: 'text-[#3A8DDE]',
      bgColor: 'bg-[#3A8DDE]/10',
    },
  ];
      ...
      <div className='bg-gradient-to-r from-[#0A2540] to-[#3A8DDE] text-white py-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-xl text-gray-200 max-w-3xl'>
            One of Las Vegas&apos; most prestigious communities, offering luxury
            living with modern amenities, excellent schools, and a
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center mb-16'>
            <div>
              ...
              <div className='space-y-4 text-gray-600 leading-relaxed'>
                <p>
                  Craig Ranch is a master-planned community located in North Las
                  Vegas, Nevada, known for its luxury homes, excellent schools,
                  and family-friendly atmosphere. Established in the early
                  2000s, the community has grown into one of the most desirable
                  neighborhoods in the Las Vegas Valley.
                </p>
                <p>
                  The area features a mix of single-family homes, luxury
                  estates, and new construction properties, all designed with
                  modern amenities and high-end finishes. Residents enjoy access
                  to parks, recreational facilities, shopping centers, and
                  top-rated schools.
                </p>
                <p>
                  With its convenient location, excellent infrastructure, and
                  strong sense of community, Craig Ranch continues to attract
                  families and professionals looking for premium living in Las
                  Vegas.
                </p>
              </div>
            </div>
